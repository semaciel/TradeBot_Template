...
# Taken from Unnamed repository provided on polo's api site
...
class poloniex:
    ...
    def returnChartData(self):
        return self.api_query("returnChartData",{'currencyPair': 'BTC_ZEC', 'start': 1501545600, 'end': 1517702400, 'period': 86400})
    ...
    def returnOrderBook (self, currencyPair, depth=1):
...
if __name__ == "__main__":
    from core.core import cfg_read

    CURDIR = input("Please enter config.ini location...")
    print("Input: " + CURDIR)
    CURDIR =  "/home/darksmac/MasterSetup/"
    api = poloniex(cfg_read(CURDIR+'config.ini', 'PoloAPI','APIkey'),cfg_read(CURDIR+'config.ini', 'PoloAPI','Secret'))
    print("IT WORKED!! >> " + api.APIKey)
	#test_core()
